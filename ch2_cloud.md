...
### Waarom Cloud? {#waarom-cloud .unnumbered}
...
[Publiek, gemeenschappelijk, privaat]{.underline}
...
Bij het formuleren van het cloudbeleid zijn er een aantal keuzes te maken die bepalend zijn voor de uitgangspunten van het beleid. Hieronder volgt een [voorbeeld]{.underline} van deze keuzes, iedere gemeente maakt uiteraard zelf haar keuzes in haar cloudbeleid:
...
### Uitdagingen en Overwegingen {#uitdagingen-en-overwegingen .unnumbered}
...
### Privacy en beveiliging {#privacy-en-beveiliging .unnumbered}
